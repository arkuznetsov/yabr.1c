...
Функция ПолучитьПравилаОбработки(ДополнительныеПараметры)
	...
	ДобавитьПравилоОбработки(ПравилаОбработки, 4, "ктв_ОбработатьЧтениеИБ", ДополнительныеПараметры);
	ДобавитьПравилоОбработки(ПравилаОбработки, 1, "ктв_ОбработатьЧтениеЖР", ДополнительныеПараметры);
	ДобавитьПравилоОбработки(ПравилаОбработки, 1, "ктв_ОбработатьЧтениеСловаряЖР", ДополнительныеПараметры);
