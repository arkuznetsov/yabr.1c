...
Процедура ОтправитьДанные()
	...
	ВремяОжиданияДанных = (ТекущаяУниверсальнаяДатаВМиллисекундах() - НачалоОбработкиПорции) / 1000;
	НачалоОбработкиПорции = ТекущаяУниверсальнаяДатаВМиллисекундах();
	...
	ОписаниеРезультата.Вставить("ВремяОтправки",
	                            (ТекущаяУниверсальнаяДатаВМиллисекундах() - НачалоОбработкиПорции) / 1000);
