...
//
// Параметры:
//  Уровень        - Число, Структура, Массив   - уровень элемента для обработки правилом,
//                                                правило обработки верхнего уровня
//                                                или массив правил обработки
...
Процедура ДобавитьПравилоОбработки(Уровень, Обработка) Экспорт
	...
	Если ТипЗнч(Уровень) = ТИп("Число") Тогда
		...
		ПравилаОбработки[Уровень].Добавить(Новый Структура("Обработка, Обработчики",
        	                                               Обработка));
